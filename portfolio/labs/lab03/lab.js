...
for (var i = 0, f; f = files[i]; i++) {
    ...
    reader.onload = function(evt){
        ...
        span.testContent = evt.target.result;
        document.getElementsById('content').insertBefore(span, null);
    }
}
}
...
function start(e) {
  document.getElementsById('files').addEventListener('change', handleFileSelect, false);
  var dropzone = document.getElementsById('drop_zone');
